...
public class GameController {
    ...
    public String index(@RequestParam String user, Model model) {
        ...
        model.addAttribute("guessHistory", new ArrayList<GuessHistory>());
        return "game";
    }
    ...
    public String makeGuess(String guess, Model model, String user) {
        ...
        List<GuessHistory> history = getGuessHistory(model);
        history.add(new GuessHistory(guess, result, attempts));
        
        model.addAttribute("user", user);
        model.addAttribute("guess", guess);
        model.addAttribute("result", result);
        model.addAttribute("attempts", attempts);
        model.addAttribute("guessHistory", history);
    ...
    /**
     * Get the guess history from the model
     */
    @SuppressWarnings("unchecked")
    private List<GuessHistory> getGuessHistory(Model model) {
        List<GuessHistory> history = (List<GuessHistory>) model.getAttribute("guessHistory");
